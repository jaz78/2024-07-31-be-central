...
public class Week01VariablesAndOperationsLab {
	...
	public static void main(String[] args) {
		...
		String streetAddress = "698 Someplace Rd";
		...
		// 8. A customer booked 2 plane seats, remove 2 seats from the available seats
		// variable
		...
		// 10. The birth certificate was printed incorrectly, change the middle initial
		// to something else

		middleInitial = 'A';

		// 11. The season has changed, update the hot outside variable to be opposite of
		// what it was
		// hotOutside = true;
		...
		String fullName = firstName + " " + middleInitial + " George";
