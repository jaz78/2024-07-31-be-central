...
public class Week04StringBuilderListSetMapLab {
	...
	public static void main(String[] args) {
		...
		/**
		 * a string is unchangeable and each one takes up a space in memory while a
		 * stringbuilder is able to be changed and manipulated without as much memory
		 * impact
		 */
		...
		System.out.println("-----------------");
		System.out.println(findShortesString(strings));
	...
	public static String findShortesString(List<String> list) {
